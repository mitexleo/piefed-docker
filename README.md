...
> Dockerized deployment of [PieFed](https://codeberg.org/rimu/pyfedi) v1.6.26 — a Lemmy/Mbin alternative written in Python with Flask.
...
> The `mitexleo/piefed-docker:v1.6.26` image is rebuilt and pushed whenever a new PieFed release is tagged.
